...
from raphael.utils.dao.context import DAO_LOGGER
...
def escape_string(value):
    ...
    charset = charset_by_id(224)  # utf8mb4 utf8mb4_unicode_ci
    return escape_string(value, charset)
...
def escape_dict(value):
    ...
    charset = charset_by_id(224)  # utf8mb4 utf8mb4_unicode_ci
    return escape_dict(value, charset)


def escape_sequence(value):
    from pymysql import escape_sequence
    from pymysql.charset import charset_by_id

    charset = charset_by_id(224)  # utf8mb4 utf8mb4_unicode_ci
    return escape_sequence(value, charset)
